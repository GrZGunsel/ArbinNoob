    ...
    return SafeArea(
      ...
      body: Column(
        children: [
          ...
          FutureBuilder(
            future: locator<AppProvider>().getUserDetail(
              ...
              return snapshot.connectionState == ConnectionState.waiting
                  ...
                  : Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          if (locator<AppProvider>().userDetail!.image != null)
                            CircleAvatar(
                              radius: 30.0,
                              backgroundImage: NetworkImage(
                                locator<AppProvider>().userDetail!.image,
                              ),
                            ),
                          CircleAvatar(
                            radius: 30.0,
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      locator<AppProvider>().userDetail!.email,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 12,
                                          fontWeight: FontWeight.w500),
